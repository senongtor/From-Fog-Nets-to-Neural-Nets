...
def main():
    ...
    for k in xrange(file_amount):
        ...
        plt.suptitle('Cross Validation + Bagging Classifier + Bagging Regressor')
        plt.savefig('Cross Validation + Bagging Classifier + Bagging Regressor.png', bbox_inches='tight')

        loss = np.sqrt(mean_squared_error(y_test, y_hat_test))
        print 'Cross Validation + Bagging Classifier + Bagging Regressor loss =', loss
        ...
        y_submission = write_submission.write_submission_binary_classifier_and_regression(
            ...
            'Cross Validation + Bagging Classifier + Bagging Regressor Submission')
